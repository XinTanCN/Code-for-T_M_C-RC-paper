    ...
    for j=0,m-1 do begin
      for k=0,1 do begin
        ...
        if (j eq 0) and (k eq 0) then begin
          fig3_ctm_rc_panel_v3_1,position,flag[j,k],j_phi,l,sym_h,mission,mlt_range[*,i],mlt,color
        endif else begin
          fig3_ctm_rc_panel_v3,position,flag[j,k],j_phi,l,sym_h,mission,mlt_range[*,i],mlt,color
        endelse
